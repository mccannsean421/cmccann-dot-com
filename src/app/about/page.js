export default function Page() {
    return (
        <main className="grid items-center h-full">
            <h1 className="text-2xl lg:text-4xl pb-6">A wee bit about me</h1>

            <p className="pb-3">Sometimes I need to remind myself but it&apos;s true but I do infact have a life outside of work.</p>
            ...
            <p className="pb-3">
                I love music, listening as well as playing. I play regular guitar and bass, 
