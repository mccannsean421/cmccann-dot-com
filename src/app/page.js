    ...
    <div className="content-container">
      <main>
        ...
        <div className="px-6 md:px-24 pb-24 grid justify-items-center">
          <h2 className="text-3xl uppercase font-bold capitalize text-white pb-24 w-full text-center -skew-x-3">
            Who am I?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 md:w-[500px] gap-10 items-center">
            <div>
              <Image
                ...
                height="500"
                width="300"
                alt="Irish lad wearing a ski mask"
              />
            </div>
            <p className="text-white text-xl">
              Hey, I&apos;m Cormac nice to meet you! I&apos;m a web developer
              with almost 10 years epxerience working across a wide range of
              industries.
            </p>
          </div>
        </div>
        ...
        <div className="pt-24 pb-6 md:py-24">
          <h2 className="text-3xl uppercase font-bold capitalize text-white w-full text-center ">
            Get In Touch
          </h2>
        </div>
